...
PYBIND11_MODULE(_aiopvxs, m) {
    ...
    m.def("pvxs_version", &version_str, "PVXS library version as a string");
    m.def("pvxs_version_int", &version_int, "PVXS_VERSION version");
    m.def("pvxs_version_abi", &version_abi_int, "PVXS_ABI_VERSION version");
